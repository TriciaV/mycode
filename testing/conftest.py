...
"""
Question: What is a monkeypatch?
Answer: The monkeypatch fixture helps you to safely set/delete an attribute, dictionary item or environment variable, or to modify sys.
path for importing during testing.
"""
import pytest
import requests
