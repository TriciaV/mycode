...
"""
This solution uses an "f string" (filename = f"admin.rc{i}". An f-string accepts variables within {} (in this case i), and auto converts that data to a string type to ensure type errors are not encountered when concatenating strings"""
